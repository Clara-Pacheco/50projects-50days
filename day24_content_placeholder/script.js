...
function getData() {
  ...
  excerpt.innerHTML = `Lorem ipsum dolor sit amet consectetur, adipisicing elit. Beatae, quia.`
  profileImg.innerHTML = `<img src="https://randomuser.me/api/portraits/men/45.jpg" alt="">`
  name.innerHTML = `John Doe`
  date.innerHTML = `Oct 08,2020`

  animated_bgs.forEach(bg => bg.classList.remove('animated-bg'))
  animated_bg_texts.forEach(bgTexts => bgTexts.classList.remove('animated-bg'))
}
